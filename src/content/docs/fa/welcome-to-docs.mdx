...
head:
  - tag: title
    content: Sudden Enlightenment docs
...
hero:
  ...
  actions:
    ...
    - text: View on GitHub
      icon: external
      variant: minimal
      link: https://github.com/mearashadowfax/Sudden Enlightenment
---
...
<CardGrid stagger>
  ...
  <Card title="ابزارها و تجهیزات" icon="seti:eslint">
    تمامی ابزارها و تجهیزات با کیفیت برتر شرکت Sudden Enlightenment را کشف کنید. هر بخش شامل مشخصات دقیق، راهنمای استفاده و نکات نگهداری است.
  </Card>
